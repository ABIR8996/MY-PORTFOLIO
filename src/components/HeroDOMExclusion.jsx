...
export default function HeroDOMExclusion({ onShare }) {
  return (
    <section id="about" className="min-h-screen pt-32 pb-20 px-6 flex flex-col justify-center max-w-7xl mx-auto relative select-none pointer-events-none">
      
      {/* Interactive CTA & Meta Pill Bar (pointer events enabled) */}
      <div className="pointer-events-auto flex flex-wrap items-center gap-3 mb-8">
      ...
      {/* Massive Typography Lockup with mix-blend-mode: exclusion */}
      <div className="relative mix-blend-exclusion z-10">
        <h1 className="text-7xl sm:text-9xl md:text-[11rem] font-extrabold tracking-tighter uppercase font-mono text-white leading-none">
          ABIR <br />
          CHOWDHURY
        </h1>

        <p className="text-2xl sm:text-4xl font-medium text-white max-w-4xl mt-6 leading-tight font-sans">
          Bridging deep hardware principles with cutting-edge software intelligence.
        </p>
      </div>

      {/* Bio Paragraph */}
      <p className="text-slate-400 text-base sm:text-lg max-w-2xl leading-relaxed font-sans mt-6 pointer-events-auto">
      ...
      {/* CTA Buttons */}
      <div className="pointer-events-auto flex flex-wrap gap-4 pt-8">
        <a
